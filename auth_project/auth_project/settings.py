...
print(BASE_DIR)  # Confira o caminho base
...
SECRET_KEY = 'django-insecure-r&j0l%$y0)=)ft!4!d^f1vm4^x3fl@-sjma200#3o7g=ikzmi1'
...
DATABASES = {
    'default': {
        ...
        'USER': 'localhost',        # Seu usuário PostgreSQL
...
AUTH_USER_MODEL = 'accounts.Usuario'  # Para usar um modelo de usuário personalizado
